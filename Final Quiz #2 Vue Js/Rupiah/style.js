<script> 
    ...
    const dummyTransactions = [
        { id: 1, text: "Salary", amount: 500.000 },
        { id: 2, text: "Flower", amount: -200.000 },
        { id: 3, text: "Book",   amount: -100.000 },
        { id: 4, text: "Camera", amount: -150.000 },
    ];
    ...
    function updateValues() {
        ...
        moneyPlus.innerText = `Rp ${income}`;
        moneyMinus.innerText = `Rp ${expense}`;
    }
